...
// Moon
ctx.fillStyle = '#bcbf69'
makeRow(styleWidth * dpi - 250, 60, 6)
makeRow(styleWidth * dpi - 270, 70, 10)
makeRow(styleWidth * dpi - 290, 80, 14)
makeRow(styleWidth * dpi - 300, 90, 16)
makeRow(styleWidth * dpi - 310, 100, 18)
makeRow(styleWidth * dpi - 320, 110, 20)
makeRow(styleWidth * dpi - 320, 120, 20)
makeRow(styleWidth * dpi - 330, 130, 22)
makeRow(styleWidth * dpi - 330, 140, 22)
makeRow(styleWidth * dpi - 340, 150, 24)
makeRow(styleWidth * dpi - 340, 160, 24)
makeRow(styleWidth * dpi - 340, 170, 24)
makeRow(styleWidth * dpi - 340, 180, 24)
makeRow(styleWidth * dpi - 340, 190, 24)
makeRow(styleWidth * dpi - 340, 200, 24)
makeRow(styleWidth * dpi - 340, 210, 24)
makeRow(styleWidth * dpi - 330, 220, 22)
makeRow(styleWidth * dpi - 330, 230, 22)
makeRow(styleWidth * dpi - 320, 240, 20)
makeRow(styleWidth * dpi - 320, 250, 20)
makeRow(styleWidth * dpi - 310, 260, 18)
makeRow(styleWidth * dpi - 300, 270, 16)
makeRow(styleWidth * dpi - 290, 280, 14)
makeRow(styleWidth * dpi - 270, 290, 10)
makeRow(styleWidth * dpi - 250, 300, 6)


ctx.fillStyle = '#d5b523'
dot(styleWidth * dpi - 200, 120)
dot(styleWidth * dpi - 210, 110)
