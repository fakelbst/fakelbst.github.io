...
(function(mod) {
  mod(codemirror, searchcursor, dialog, matchbrackets);
})(function(CodeMirror) {
        ...
        switch (zoomType) {
            case ZoomType.IN:
                if (dots[0].classList.contains('zoomout')) {
                    dots.forEach(function (el) { return el.classList.toggle('zoomout'); });
                }
                else {
                    dots.forEach(function (el) { return el.classList.toggle('zoomin'); });
                }
                break;
            case ZoomType.OUT:
    ...
    return (react.createElement("div", { className: "container" },
        react.createElement("div", { className: "toolbar" },
            react.createElement("div", { className: "toolbox" },
                react.createElement("div", { className: "current-color", style: { background: "rgb(" + COLORS[selectedColorIndex][0] + ", " + COLORS[selectedColorIndex][1] + ", " + COLORS[selectedColorIndex][2] + ")" } }),
                react.createElement("div", { className: "colors" }, COLORS.map(function (el, index) {
            ...
            react.createElement("div", { className: "toolbox tools" },
                ...
                react.createElement("svg", { onClick: function () { return zoom(ZoomType.IN); }, className: "icon", viewBox: "0 0 1024 1024", version: "1.1", xmlns: "http://www.w3.org/2000/svg", "p-id": "2136", width: "200", height: "200" },
                    react.createElement("path", { d: "M630.272 439.808H331.264c-16.384 0-29.696 14.336-29.696 31.744 0 17.92 13.312 32.256 29.696 32.256h299.008c16.384 0 29.696-14.336 29.696-31.744 0-17.408-13.312-31.744-29.696-32.256z", fill: "#cccfe2", "p-id": "2137" }),
                    react.createElement("path", { d: "M512.512 621.568V322.56c0-16.384-14.336-29.696-31.744-29.696-17.92 0-32.256 13.312-32.256 29.696v299.008c0 16.384 14.336 29.696 31.744 29.696 17.408 0 31.744-13.824 32.256-29.696z", fill: "#cccfe2", "p-id": "2138" }),
